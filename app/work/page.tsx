												...
												<div className="card__content px-md-4 px-3">
													<div className="card__title d-md-flex align-items-center mb-0 mb-lg-2">
														<Link href="/work-single" className="card_title_link">
															<p className="text-primary-1 mb-0 mb-md-2">Software Development</p>
															<h3 className="fw-semibold">HR System</h3>
														</Link>
													...
													<p className="text-300 mb-lg-auto mb-md-4 mb-3">Developed a dynamic HR application to enhance employee management and communication. Created intuitive navigation, interactive profiles, and collaboration features to streamline HR tasks and boost engagement.</p>
