								...
								<div className="col-lg-8 mx-lg-auto">
									<div className="text-center">
										...
										<h3 className="ds-3 mt-3 mb-4 text-dark">
											Transforming Ideas
											<span className="text-300"> Intuitive Designs for </span>
											Immersive Digital.
											<span className="text-300">Experiences</span>
										</h3>
										<p className="text-300 fs-5">
										Empowering digital innovation with expert web & software development, immersive Blender 3D modeling, and creative graphic design.
										</p>
									</div>
										...
										<div className="card-custom" data-index={0}>
													...
													<div className="card__content mt-lg-5 mt-md-4 mt-3 pb-4">
														<div className="d-md-flex content">
															...
															<p className="card__description text-300 fs-6 mb-0">
																Utilizing modern technologies like React, HTML, CSS, and JavaScript to create responsive and interactive web pages that provide an engaging user experience.
															</p>
														</div>
														<div className="d-md-flex content">
															<p className="fs-7 text-dark text-uppercase w-md-40 pe-8 mb-2 d-inline-block">
															...
															<p className="card__description text-300 fs-6 mb-0">
																Implementing server-side logic and database management with technologies such as Laravel, Node.js to ensure seamless performance and data integrity.
															</p>
														</div>
														<div className="d-md-flex content">
															<p className="fs-7 text-dark text-uppercase w-md-40 pe-8 mb-2 d-inline-block">
											...
											<div className="card-custom" data-index={0}>
												<div className="card__inner bg-6 px-md-5 py-md-6 px-3 py-4">
													<div className="card__title d-flex align-items-center mb-md-4 mb-3">
														<Link href="" className="card_title_link">
															<h3 className="fw-semibold mb-2">3D Product Modeling</h3>
															<p className="mb-0">Creative. Unique. Reality. </p>
														</Link>
														<Link href="" className="card-icon border text-dark border-dark icon-shape ms-auto icon-md rounded-circle">
															<i className="ri-arrow-right-up-line" />
													...
													<div className="card__content mt-lg-5 mt-md-4 mt-3 pb-4">
														<div className="d-md-flex content">
															...
															<p className="card__description text-300 fs-6 mb-0">
															Start with market study and user insights to shape a clear design vision.
															</p>
														</div>
														<div className="d-md-flex content">
															<p className="fs-7 text-dark text-uppercase w-md-40 pe-8 mb-2 d-inline-block">
															...
															<p className="card__description text-300 fs-6 mb-0">
															Use Blender to craft detailed models with realistic textures and lighting.
															</p>
														</div>
														<div className="d-md-flex content">
															<p className="fs-7 text-dark text-uppercase w-md-40 pe-8 mb-2 d-inline-block">
															...
															<p className="card__description text-300 fs-6 mb-0">
															Build animated prototypes to showcase design flow and visual appeal.
															</p>
														</div>
													</div>
												</div>
											...
											<div className="card-custom" data-index={0}>
												<div className="card__inner bg-6 px-md-5 py-md-6 px-3 py-4">
													<div className="card__title d-flex align-items-center mb-md-4 mb-3">
														<Link href="" className="card_title_link">
															<h3 className="fw-semibold mb-2">Data Anaylist</h3>
															<p className="mb-0">Creative. Unique. Reality. </p>
														</Link>
														<Link href="" className="card-icon border text-dark border-dark icon-shape ms-auto icon-md rounded-circle">
															<i className="ri-arrow-right-up-line" />
													...
													<div className="card__content mt-lg-5 mt-md-4 mt-3 pb-4">
														<div className="d-md-flex content">
															...
															<p className="card__description text-300 fs-6 mb-0">
															Gather data through surveys, interviews, and reports to understand trends.</p>
														</div>
														<div className="d-md-flex content">
															<p className="fs-7 text-dark text-uppercase w-md-40 pe-8 mb-2 d-inline-block">
															...
															<p className="card__description text-300 fs-6 mb-0">
															Organize raw data and remove errors for clear insights.</p>
														</div>
														<div className="d-md-flex content">
															<p className="fs-7 text-dark text-uppercase w-md-40 pe-8 mb-2 d-inline-block">
															...
															<p className="card__description text-300 fs-6 mb-0">
															Create simple charts and dashboards to share findings.</p>
														</div>
													</div>
												</div>
											</div>
							...
							<div className="inner">
								<div className="row align-items-center justify-content-between">
									...
									<div className="col-lg-auto col-md-6">
										<div className="counter-item-cover counter-item">
											<div className="content text-center mx-auto d-flex align-items-center">
												<span className="ds-3 count text-primary-1 fw-medium my-0">+<span className="odometer ds-1 text-dark fw-semibold">7</span></span>
												<div className="text-start ms-2">
									...
									<div className="col-lg-auto col-md-6">
										<div className="counter-item-cover counter-item">
											<div className="content text-center mx-auto d-flex align-items-center">
												<span className="ds-3 count text-primary-1 fw-medium my-0">+<span className="odometer ds-1 text-dark fw-semibold">120</span></span>
												<div className="text-start ms-2">
