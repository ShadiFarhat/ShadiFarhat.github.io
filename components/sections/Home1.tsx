				...
				<div className="container position-relative z-3">
					<div className="row">
						<div className="col-lg-6 col-md-12">
							<span className="text-dark">👋 Hello It's Shadi Farhat !</span>
							<h1 className="ds-3 mb-3">Full Stack Developer <span className="text-primary-1">& Graphic Designer</span></h1>
							<p className="text-300 mb-6">Versatile professional in graphic design, junior development, 3D modeling, and data
                        analysis.
                        Showcasing innovative, visually compelling solutions.</p>
							...
							<p className="text-400 mt-6 mb-3">+2 years with professional software development | 7+ Years experience with Graphic Design</p>
							<div className="d-flex gap-3">
								...
								<div className="brand-logo icon-xl icon-shape rounded-3 bg-900 d-none d-md-flex">
									<img src=" assets/imgs/hero/hero-1/brand-7.png" alt="brand" />
								</div>
							</div>
						</div>
					</div>
