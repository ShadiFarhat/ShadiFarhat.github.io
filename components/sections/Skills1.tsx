				...
				<div className="container">
					<div className="row">
						...
						<div className="d-flex flex-wrap flex-lg-nowrap justify-content-center gap-3 mb-7 px-6">
							...
							<div className="skills">
								...
								<div className="skills-ratio text-center">
									...
									<p className="text-400 fw-medium text-uppercase">Premier</p>
								</div>
							</div>
							<div className="skills">
								<div className="skills-icon mb-5">
						...
						<div className="text-center">
							<p className="fs-5 text-200 mb-0">In addition, I am excellent with: </p>
							<div className="d-flex justify-content-center gap-1">
								<Link href="/#" className="fs-5 fw-bold">HTML,</Link>
								<Link href="/#" className="fs-5 fw-bold">CSS,</Link>
								<Link href="/#" className="fs-5 fw-bold">Excel,</Link>
								<Link href="/#" className="fs-5 fw-bold">VBA</Link>
								<Link href="/#" className="fs-5 fw-bold">PowerPoint,</Link>
							</div>
						</div>
					</div>
				</div>
