			...
			<section id="resume" className="section-resume-1 position-relative pt-150 overflow-hidden" data-background="assets/imgs/projects/projects-1/background.png">
								...
								<div className="resume-card-item px-4 py-3 mt-5">
										<div className="d-flex align-items-end">
											<div>
												...
												<h5>Certification in Computer Science</h5>
												<p className="text-300 mb-0">Arab Open University</p>
											</div>
											<h3 className="text-linear-1 ms-auto fw-semibold">3.5<span className="fs-4 fw-bold">/5</span></h3>
										</div>
									</div>
									<div className="resume-card-item px-4 py-3 mt-5">
										<div className="d-flex align-items-end">
											<div>
												<p className="fw-extra-bold text-linear-1 mb-2">2015-2018</p>
												<h5>Certification in Banking and Finance</h5>
												<p className="text-300 mb-0">Antonine University</p>
											</div>
											<h3 className="text-linear-1 ms-auto fw-semibold">4<span className="fs-4 fw-bold">/5</span></h3>
										</div>
									</div>
								</div>
							</div>
							...
							<div className="resume-card p-lg-6 p-4 h-100">
								...
								<div className="resume-card-body">
									<div className="resume-card-item px-4 py-3 mt-5">
										...
										<h5>IT Manager</h5>
										<p className="text-300 mb-0">Maliks Lebanon</p>
									</div>
									<div className="resume-card-item px-4 py-3 mt-5">
										<p className="fw-extra-bold text-linear-1 mb-2">2021-2025</p>
										<h5>Head of Graphic Designer</h5>
										<p className="text-300 mb-0">Maliks Lebanon</p>
									</div>
									<div className="resume-card-item px-4 py-3 mt-5">
										<p className="fw-extra-bold text-linear-1 mb-2">2019-2021</p>
										<h5>Graphic Designer</h5>
										<p className="text-300 mb-0">Maliks Lebanon</p>
									</div>
									<div className="resume-card-item px-4 py-3 mt-4">
										<p className="fw-extra-bold text-linear-1 mb-2">2015-2019</p>
										<h5>Junior Designer</h5>
										<p className="text-300 mb-0">Euro Prints</p>
									</div>
								</div>
							</div>
						</div>
				...
				<div className="scroll-move-right position-relative pb-160 pt-lg-150">
					<div className="d-flex align-items-center gap-5 wow img-custom-anim-top position-absolute top-50 start-50 translate-middle">
						<h3 className="stroke fs-150 text-uppercase text-white">Branding . Modeling . User Interface</h3>
					</div>
				</div>
			</section>
