...
function initProjectModal() {
    ...
    // ============================================
    const designData = {
        'billboards': { category: 'Graphic', title: 'Billboards', description: 'Large-format billboard designs for outdoor advertising. Eye-catching visuals optimized for maximum impact.', software: 'Adobe Photoshop', year: '2024', images: ['assets/design/billboards/mockup.webp', 'assets/design/billboards/1.webp', 'assets/design/billboards/2.webp'] },
        'farhat-market': { category: 'Branding', title: 'Farhat Market', description: 'Complete brand identity for Farhat Market. Logo design, color scheme, and marketing materials.', software: 'Adobe Illustrator', year: '2024', images: ['assets/design/farhat-market/mockup.webp', 'assets/design/farhat-market/1.webp', 'assets/design/farhat-market/2.webp', 'assets/design/farhat-market/3.webp', 'assets/design/farhat-market/4.webp'] },
        'netflix': { category: 'UI/UX', title: 'Netflix Redesign', description: 'UI/UX concept design inspired by Netflix. Modern interface with focus on user experience.', software: 'Adobe Photoshop', year: '2024', images: ['assets/design/netflix/mockup.webp'] },
        'posters': { category: 'Graphic', title: 'Movie Posters', description: 'Creative movie poster designs including Avatar and custom film concepts. Bold typography and striking visuals.', software: 'Adobe Photoshop', year: '2024', images: ['assets/design/posters/mockup.webp', 'assets/design/posters/1.webp', 'assets/design/posters/2.webp'] },
        'guitar-center': { category: 'Branding', title: 'Guitar Center', description: 'Brand identity design for Guitar Center. Music-inspired visuals with modern aesthetics.', software: 'Adobe Illustrator', year: '2024', images: ['assets/design/guitar-center/mockup.webp', 'assets/design/guitar-center/1.webp', 'assets/design/guitar-center/2.webp', 'assets/design/guitar-center/3.webp'] },
        'laundry': { category: 'Graphic', title: 'Laundry Poster', description: 'Promotional poster design for laundry service. Fresh and clean design approach.', software: 'Adobe Photoshop', year: '2024', images: ['assets/design/laundry/mockup.webp'] },
